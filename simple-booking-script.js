...
(function() {
  ...
  const locations = [
    ...
    { name: 'Split Bus Station', city: 'Split', icon: 'ðŸšŒ' },
    { name: 'Split Train Station', city: 'Split', icon: 'ðŸš‚' },
    { name: 'Split City Center', city: 'Split', icon: 'ðŸ™ï¸' },
    { name: 'Split Old Town', city: 'Split', icon: 'ðŸ°' },
    { name: 'Plitvice Lakes', city: 'Plitvice', icon: 'ðŸžï¸' },
    { name: 'Split Old Town', city: 'Split', icon: 'ðŸ›ï¸' },
