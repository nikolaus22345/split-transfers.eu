...
function send_booking_email($pickup, $dropoff, $date, $people, $transfer_type) {
    $admin_email = get_option('admin_email'); // ili 'splittransfers.eu@gmail.com'
    
    $subject = 'Nova Rezervacija Transfera - Split Transfers';
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <div class='field'>
                    <span class='label'>🎯 Odredište:</span>
                ...
                <div class='field'>
                    <span class='label'>🔄 Tip transfera:</span>
    ...
    $headers = [
        ...
        'From: Split Transfers <splittransfers.eu@gmail.com>'
    ];
...
add_shortcode('Split_booking_form', 'render_booking_form_shortcode');
add_shortcode('Dubrovnik_booking_form', 'render_booking_form_shortcode'); // alias (stari shortcode)
